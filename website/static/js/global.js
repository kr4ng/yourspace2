...
function initialize_map() {
	...
	var image = new google.maps.MarkerImage(
		'https://s3-us-west-2.amazonaws.com/yourspace2/css/images/icon_marker.png',
	...
	google.maps.event.addListener( marker, 'click', function() {
		...
		var content = '<div id="info" class="span6" style="height: 85px;"><strong>YourSpace</strong><p style="margin:0; padding:0">1224 E. Green St., Pasadena, CA<br />91101</a></p>' + '</div>';
